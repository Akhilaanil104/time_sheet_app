...
// //         // Parse the response data into a list of ProjectModel
// //         List<ProjectModel> projects = (response.data as List)
// //             .map((project) => ProjectModel.fromJson(project))
// //             .toList();

// //         return Right(projects); // Return the list wrapped in Right
// //       } else {
